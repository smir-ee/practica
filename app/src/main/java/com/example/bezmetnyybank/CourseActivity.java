...
import com.example.bezmetnyybank.R;
import com.example.bezmetnyybank.entities.ValuteEntity;
import com.example.bezmetnyybank.xml_parser;
...
public class CourseActivity extends AppCompatActivity {
    ...
    private ArrayList<ValuteEntity> valuteArrayList;
    private ArrayList<ValuteEntity> valuteArrayListLast;
...
//        getSupportActionBar().hide();
    ...
    private class customAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ValuteEntity valute = (ValuteEntity) getItem(position);

            TextView title = (TextView) convertView.findViewById(R.id.name);
            title.setText(valute.getName());

            TextView charcode = (TextView) convertView.findViewById(R.id.currency);
