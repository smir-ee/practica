...
class BanksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bankomat1);
    ...
    private class parsingJson extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if (parser.parsingData(s))
                entityBanks = parser.getBanksArrayList();
    ...
    private class customAdapter extends ArrayAdapter{
        ...
        public customAdapter(@NonNull Context context) {
            super(context, R.layout.bankrow, entityBanks);
        }
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            try {
                if (convertView == null){
                    ...
                    convertView = (View) inflater.inflate(R.layout.bankrow, null);
                }
