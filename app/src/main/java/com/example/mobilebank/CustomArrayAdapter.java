...
public class CustomArrayAdapter extends ArrayAdapter<ListItem> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        if(convertView == null){
                convertView = inflater.inflate(R.layout.course_maket, null, false);
                viewHolder = new ViewHolder();
                viewHolder.data1 = convertView.findViewById(R.id.valute);
                viewHolder.data2 = convertView.findViewById(R.id.valutefull);
                viewHolder.data3 = convertView.findViewById(R.id.cost_up);
                viewHolder.data4 = convertView.findViewById(R.id.cost_down);
