...
public class CourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.textView_Date_CourseAct);
    ...
    private void init(){
        listView = findViewById(R.id.bysold);
        arrayList = new ArrayList<>();
        adapter = new CustomArrayAdapter(this, R.layout.course_maket, arrayList ,getLayoutInflater());
