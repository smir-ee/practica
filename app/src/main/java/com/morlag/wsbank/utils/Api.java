    ...
    private void parseBankomats(String json, ArrayList<Bankomat> bankomats){
        ...
        try {
            ...
            for(int i = 0; i < array.length(); i++){
                ...
                tempTw[0] = object.getString("mon");
                tempTw[1] = object.getString("tue");
                tempTw[2] = object.getString("wed");
                tempTw[3] = object.getString("thu");
                tempTw[4] = object.getString("fri");
                tempTw[5] = object.getString("sat");
                tempTw[6] = object.getString("sun");
